      ...
      <div className="site-container footer-grid">
        ...
        <div className="footer-column footer-connect">
          ...
          <div className="footer-socials-row">
            ...
            <a href="https://chat.whatsapp.com/KloK0eNsAv7CAEb8MuQdXK" target="_blank" rel="noreferrer" className="footer-icon-btn footer-wa-btn" aria-label="Join TheatreHub Official WhatsApp Group" title="Join Official WhatsApp Group">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
